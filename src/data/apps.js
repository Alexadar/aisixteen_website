export const apps = [
  ...
  },
  {
    slug: 'big-pink-cat',
    name: 'Big Pink Cat',
    description: 'Embark on a cosmic visual adventure with Big Pink Cat. Meet the mysterious Pink Cat and uncover the secrets of the universe through an interactive story. Choose your path, shape your destiny, and discover what awaits among the stars.',
